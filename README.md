...
* Artículos varios un poco tipo wiki sobre diversos temas, como [Linux](linux/) y [programación](programming/).
...
Más cosas escritas [en español](https://alex.corcoles.net/notas/) y [en inglés](https://alex.corcoles.net/notes/).
...
* Wiki-like articles on topics such as [Linux](linux/), and [programming](programming/).
