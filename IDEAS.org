...
- Integrate an XMPP server (such as [[https://esl.github.io/MongooseDocs/latest/modules/mod_jingle_sip/][MongooseIM with mod_jingle_sip]]) with SIP systems (such as Flexisip).

** Peer-to-peer encrypted NAS backups
...
** Test SteamOS for streaming service usage.
